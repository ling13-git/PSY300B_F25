...
#use the same plat as before 

plot(health$mood, health$eating, main='Scatter Plot Mood and Calories Eaten with Line of Best Fit', xlab='Mood', ylab='Calories Eaten')
abline(model)
